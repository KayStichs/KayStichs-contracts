# Code of Conduct — KayStichs Contracts

> Adapted from the Contributor Covenant 2.1.
> Our pledge: open, welcoming, harassment-free participation in the KayStichs smart-contract workspace.
...
pull requests, discussions, Discord, and any other KayStichs-hosted venue —
and also applies when an individual is officially representing the community
in public spaces. Examples of representing the community include using an
...
`conduct@kaystichs.dev`. All complaints will be reviewed and investigated
promptly and fairly.
...
*For questions about this code of conduct, reach `conduct@kaystichs.dev`.*
